                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="<?= base_url('autentikasi'); ?>">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" value="<?= set_value('email'); ?>" id="email" aria-describedby="emailHelp" placeholder="Email" name="email">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url('autentikasi/register'); ?>">Buat Akun Baru</a>
                                    </div>
                                </div>
                            </div>
                        </div>
